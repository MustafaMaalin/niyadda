...
export const showcase = [
  ...
  },
  {
    ...
    content: [
      {
        title: "Moorooka Mosque",
        heading1: "Moorooka Mosque: Digitally Amplifying the Beliefs of the Community",
        text0: "Moorooka Mosque, a cornerstone of faith and community, provided us with a unique palette of cultural and spiritual events. Each gathering, whether it was a solemn prayer, Friday congregation or a vibrant community get-together, carried its own narrative, values, and significance. Our role? To capture this essence and paint a digital tapestry that resonated with both attendees and those who couldn't be present in person.",
  ...
  },
  {
    ...
    content: [
      {
        title: "Multicultural Healthcare",
        heading1: "Multicultural Healthcare: Pioneering Digital Outreach in Disability Support",
        text0: "At the heart of community care lies Multicultural Healthcare, a beacon for inclusive disability support under the NDIS. Their commitment to diverse and individualised care needed a digital counterpart that would resonate with their vision and values, and that's where our journey began.",
        text1: "Figma became our initial workspace, where the essence of Multicultural Healthcare started taking shape. Vibrant layouts intertwined with user-friendly designs reflected the organisation’s mission of extending a helping hand to those from all walks of life. It was here that we envisioned a digital experience tailored to their unique clientele.",
...
export const blogdata = [
  {
    ...
    content: [
      {
        title: "The Story of Niyadda: From Twitter Friends to Business Partners",
        text0: "It's not every day that two individuals, continents apart, turn a shared passion into a thriving venture. This is the story of Kalid and Mustafa, the duo behind Niyadda, a testament to the possibilities of our digital age.",
        heading1: "A Friendship Forged on Twitter",
        text1:"In 2019, the vast world of Twitter brought together two like-minded souls: Kalid, hailing from the sun-kissed coasts of Australia, and Mustafa, nestled amidst the tulips of the Netherlands. A seemingly random interaction soon unveiled a shared academic pursuit. Both were diving deep into the world of Information Technology at their respective universities. As tweets turned to direct messages, their conversations found more common ground: a shared zeal for web development.",
        heading2: "Turning Passion into Profession",
        text2: "Amidst late-night coding sessions, academic challenges, and personal growth, a mutual respect and camaraderie blossomed. The idea of monetising their skills began as a whisper. Why not create websites? After all, they had the talent, the shared vision, and a rapidly growing trust in one another. The geographical distance that might've been a barrier for many was merely a logistical detail for them. After all, the internet had already proven its power by bringing them together in the first place.",
        heading3: "Beyond Borders and Time Zones",
        text3: "With Kalid in Australia and Mustafa in the Netherlands, one would expect timing to be a challenge. But instead, they turned it into an advantage. Operating nearly round the clock, they were able to deliver faster, covering almost all time zones between them.", 
        heading4: "Four Years and Counting...",
        text4: "Now, almost half a decade into this journey, one might expect them to rest on their laurels. But for Kalid and Mustafa, the journey of Niyadda is only just beginning. From a serendipitous Twitter meeting to a full-blown business partnership, they've shown that with passion, trust, and a bit of digital magic, anything is possible.",
      },
    ]
    ,
    },
    ...
    content: [
      {
        ...
        heading8:"Final Thoughts: Empowering Your Web Design Journey with Figma",
        text8:"In the constantly evolving realm of web design, Figma emerges as an invaluable ally for designers who constantly push boundaries and strive to create exceptional user experiences. Its collaborative nature, responsive design features, and diverse set of tools make it an indispensable component of any designer's toolkit. By mastering Figma, you're not just designing web interfaces - you're crafting meaningful interactions that captivate and engage users in the digital world. So, dive in, experiment, and let Figma unlock your creative potential, taking your web design endeavors to new heights.",
      },
    ]
    ,
    },
